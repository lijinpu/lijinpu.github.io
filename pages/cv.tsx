      ...
      <main className="flex-1">
        ...
        <div>
          ...
          <ul>
            ...
            <li>李金璞, 孙浩宁*, 董丰, 汤珂. 数字时代宏观经济学的研究新进展[J]. 经济学动态, 2026, (03): 203-224.</li>
          ...
          <ul>
            <li>
            Academic Research Training for Xuetang Class (40512742) by Prof. Feng Dong & Binzhen Wu. 2026 Summer.</li>

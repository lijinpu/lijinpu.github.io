...
export default function Research() {
  return (
    <div className="flex flex-col relative max-w-none prose dark:prose-invert">
        ...
        <p>
        “Capitalization of Data Assets and the Financial Constraint”, with Ke Tang.
        </p>
        <p>
        “Data Collection and Pricing on a Two-sided Market”, with Ronghua Sui and Ruize Gao.
        </p>
        <h2>Books & Book Chapters</h2>
        <p>
       “数据资产化” , 汤珂主编, 人民出版社, 2023. 参与撰写第二章《数据资产的确认》, 第五章《数据资产价值评估》.
        </p>
        <p>
